  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'brand': '0 4px 16px rgba(107,94,240,0.30)',
        'brand-lg': '0 8px 32px rgba(107,94,240,0.40)',
        'inner':  'inset 0 2px 4px rgba(0,0,0,0.06)',
        'none':   'none',
      },
      backgroundImage: {
        'gradient-brand':    'linear-gradient(135deg, #6B5EF0 0%, #7C3AED 50%, #06B6D4 100%)',
        'gradient-brand-r':  'linear-gradient(135deg, #06B6D4 0%, #7C3AED 50%, #6B5EF0 100%)',
        'gradient-hero':     'radial-gradient(ellipse 80% 60% at 50% -10%, rgba(107,94,240,0.3) 0%, transparent 70%)',
        'gradient-dark':     'linear-gradient(180deg, #0B0B13 0%, #15151F 100%)',
        'gradient-card':     'linear-gradient(135deg, rgba(107,94,240,0.08) 0%, rgba(124,58,237,0.04) 100%)',
        'mesh-purple':       'radial-gradient(at 40% 20%, rgba(107,94,240,0.15) 0px, transparent 50%), radial-gradient(at 80% 0%, rgba(124,58,237,0.10) 0px, transparent 50%), radial-gradient(at 0% 50%, rgba(6,182,212,0.10) 0px, transparent 50%)',
      },
      animation: {
